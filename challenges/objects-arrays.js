...
const lowerCase = zooAnimals.map(creature =>
  creature.animal_name.toLowerCase()
);
...
let concenred = "concerned";
*/
const lowerPopulation = zooAnimals.filter(creature => creature.population < 5);
...
*/
const populationTotal = zooAnimals.reduce((totalPop, creature) => {
  return (totalPop += creature.population);
}, 0);
